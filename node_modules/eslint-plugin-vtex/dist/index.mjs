...
var isComponentName;
var init_isComponentName = __esm({
  "src/utils/react/isComponentName.ts"() {
    "use strict";
    isComponentName = (name) => name.length > 0 && name[0] === name[0].toUpperCase();
  }
});
...
var isInsideAnotherFunction;
var init_isInsideAnotherFunction = __esm({
  "src/utils/estree/isInsideAnotherFunction.ts"() {
    "use strict";
    init_isFunctionNode();
    isInsideAnotherFunction = (context) => {
...
var getFunctionNodeName;
var init_getFunctionNodeName = __esm({
  "src/utils/estree/getFunctionNodeName.ts"() {
    "use strict";
...
var consistentPropsType;
var init_consistent_props_type = __esm({
  "src/rules/consistent-props-type.ts"() {
    "use strict";
    init_isComponentName();
    init_createRule();
    init_isInsideAnotherFunction();
    init_getFunctionNodeName();
    init_isFunctionNode();
    consistentPropsType = createRule({
...
var init_prefer_early_return = __esm({
  "src/rules/prefer-early-return.ts"() {
    "use strict";
    init_createRule();
    preferEarlyReturn = createRule({
...
var USE_EFFECT_NAME, preferUseEffectNamedCallback;
var init_prefer_use_effect_named_callback = __esm({
  "src/rules/prefer-use-effect-named-callback.ts"() {
    "use strict";
    init_createRule();
    USE_EFFECT_NAME = "useEffect";
    preferUseEffectNamedCallback = createRule({
...
var require_src = __commonJS({
  "src/index.ts"(exports, module) {
    init_recommended();
    init_consistent_props_type();
    init_prefer_early_return();
    init_prefer_use_effect_named_callback();
    module.exports = {
      configs: {
        recommended
      },
