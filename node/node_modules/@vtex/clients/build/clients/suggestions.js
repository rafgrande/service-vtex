...
class Suggestions extends api_1.ExternalClient {
    ...
    getAllSuggestions(authMethod = 'AUTH_TOKEN', tracingConfig) {
        ...
        return this.http.get('', (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    ...
    getSuggestionById(sellerId, sellerSkuId, authMethod = 'AUTH_TOKEN', tracingConfig) {
        ...
        return this.http.get(routes.sellerSkuId(sellerId, sellerSkuId), (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    // eslint-disable-next-line max-params
    sendSkuSuggestion(body, authMethod = 'AUTH_TOKEN', tracingConfig) {
        ...
        return this.http.put(routes.sellerSkuId(sellerId, sellerSkuId), body, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    // eslint-disable-next-line max-params
    deleteSkuSuggestion(sellerId, sellerSkuId, authMethod = 'AUTH_TOKEN', tracingConfig) {
        const metric = 'suggestions-deleteSkuSuggestion';
        return this.http.delete(routes.sellerSkuId(sellerId, sellerSkuId), (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    // eslint-disable-next-line max-params
    getAllVersions(sellerId, sellerSkuId, authMethod = 'AUTH_TOKEN', tracingConfig) {
        const metric = 'suggestions-deleteSkuSuggestion';
        return this.http.get(routes.versions(sellerId, sellerSkuId), (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    // eslint-disable-next-line max-params
    getVersionById(sellerId, sellerSkuId, version, authMethod = 'AUTH_TOKEN', tracingConfig) {
        const metric = 'suggestions-deleteSkuSuggestion';
        return this.http.get(routes.versionById(sellerId, sellerSkuId, version), (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
}
