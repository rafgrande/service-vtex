...
class OMS extends api_1.JanusClient {
    ...
    userLastOrder(authMethod = 'AUTH_TOKEN', tracingConfig) {
        ...
        return this.http.get(routes.lastOrder, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    order(id, authMethod = 'AUTH_TOKEN', tracingConfig) {
        const metric = 'oms-order';
        return this.http.get(routes.order(id), (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    // eslint-disable-next-line max-params
    orderNotification(id, body, authMethod = 'AUTH_TOKEN', tracingConfig) {
        const metric = 'oms-orderNotification';
        return this.http.post(routes.notification(id), body, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    cancelOrder(id, authMethod = 'AUTH_TOKEN', tracingConfig) {
        const metric = 'oms-cancelOrder';
        return this.http.post(routes.cancel(id), (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
}
exports.OMS = OMS;
