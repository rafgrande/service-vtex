...
class Checkout extends api_1.JanusClient {
    ...
    getOrderFormConfiguration(authMethod = 'AUTH_TOKEN', tracingConfig) {
        ...
        return this.http.get(routes.orderFormConfiguration, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    setOrderFormConfiguration(body, authMethod = 'AUTH_TOKEN', tracingConfig) {
        const metric = 'checkout-setOrderFormConfiguration';
        return this.http.post(routes.orderFormConfiguration, body, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    ...
    setSingleCustomData(orderFormId, customData, authMethod = 'AUTH_TOKEN', tracingConfig) {
        ...
        return this.http.put(routes.singleCustomData(orderFormId, appId, appFieldName), { value }, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    // eslint-disable-next-line max-params
    addItem(orderFormId, items, queryString = '', authMethod = 'STORE_TOKEN', tracingConfig) {
        const metric = 'checkout-addItem';
        return this.http.post(routes.addItem(orderFormId, queryString), { orderItems: items }, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    // eslint-disable-next-line max-params
    cancelOrder(orderFormId, reason, authMethod = 'STORE_TOKEN', tracingConfig) {
        const metric = 'checkout-cancelOrder';
        return this.http.post(routes.cancelOrder(orderFormId), { reason }, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    // eslint-disable-next-line max-params
    setOrderFormCustomData(orderFormId, appId, field, value, authMethod = 'STORE_TOKEN', tracingConfig) {
        ...
        return this.http.put(routes.orderFormCustomData(orderFormId, appId, field), { value }, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    // eslint-disable-next-line max-params
    updateItems(orderFormId, orderItems, authMethod = 'STORE_TOKEN', tracingConfig) {
        const metric = 'checkout-updateItems';
        return this.http.post(routes.updateItems(orderFormId), { orderItems }, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    // eslint-disable-next-line max-params
    updateOrderFormPayment(orderFormId, payments, authMethod = 'STORE_TOKEN', tracingConfig) {
        ...
        return this.http.post(routes.attachmentsData(orderFormId, 'paymentData'), { payments }, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    // eslint-disable-next-line max-params
    updateOrderFormProfile(orderFormId, fields, authMethod = 'STORE_TOKEN', tracingConfig) {
        ...
        return this.http.post(routes.attachmentsData(orderFormId, 'clientProfileData'), fields, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    // eslint-disable-next-line max-params
    updateOrderFormShipping(orderFormId, shippingAddress, authMethod = 'STORE_TOKEN', tracingConfig) {
        ...
        this.http.post(routes.attachmentsData(orderFormId, 'shippingData'), shippingAddress, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    // eslint-disable-next-line max-params
    updateOrderFormMarketingData(orderFormId, marketingData, authMethod = 'STORE_TOKEN', tracingConfig) {
        ...
        return this.http.post(routes.attachmentsData(orderFormId, 'marketingData'), marketingData, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    // eslint-disable-next-line max-params
    updateOrderFormClientPreferencesData(orderFormId, clientPreferencesData, authMethod = 'STORE_TOKEN', tracingConfig) {
        ...
        return this.http.post(routes.attachmentsData(orderFormId, 'clientPreferencesData'), filteredClientPreferencesData, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    // eslint-disable-next-line max-params
    addAssemblyOptions(orderFormId, itemId, assemblyOptionsId, body, authMethod = 'STORE_TOKEN', tracingConfig) {
        ...
        return this.http.post(routes.assemblyOptions(orderFormId, itemId, assemblyOptionsId), body, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    // eslint-disable-next-line max-params
    async removeAssemblyOptions(orderFormId, itemId, assemblyOptionsId, body, authMethod = 'STORE_TOKEN', tracingConfig) {
        ...
        return this.http.delete(routes.assemblyOptions(orderFormId, itemId, assemblyOptionsId), {
            ...(0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig),
            data: body,
        });
    }
    // eslint-disable-next-line max-params
    updateOrderFormCheckin(orderFormId, checkinPayload, authMethod = 'STORE_TOKEN', tracingConfig) {
        ...
        return this.http.post(routes.checkin(orderFormId), checkinPayload, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    orderForm(orderFormId, authMethod = 'STORE_TOKEN', tracingConfig) {
        const metric = 'checkout-orderForm';
        return this.http.post(routes.orderForm(orderFormId), { expectedOrderFormSections: ['items'] }, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    orderFormRaw(authMethod = 'STORE_TOKEN', tracingConfig) {
        const metric = 'checkout-orderForm';
        return this.http.post(routes.orderForm(), { expectedOrderFormSections: ['items'] }, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    newOrderForm(orderFormId, authMethod = 'STORE_TOKEN', tracingConfig) {
        const metric = 'checkout-newOrderForm';
        return this.http.post(routes.orderForm(orderFormId), undefined, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    orders(authMethod = 'STORE_TOKEN', tracingConfig) {
        const metric = 'checkout-orders';
        return this.http.get(routes.orders, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    // eslint-disable-next-line max-params
    simulation(simulation, queryString = '', authMethod = 'STORE_TOKEN', tracingConfig) {
        const metric = 'checkout-simulation';
        return this.http.post(routes.simulation(queryString), simulation, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    // eslint-disable-next-line max-params
    updateOrderFormIgnoreProfile(orderFormId, ignoreProfileData, authMethod = 'STORE_TOKEN', tracingConfig) {
        ...
        return this.http.patch(routes.profile(orderFormId), { ignoreProfileData }, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
}
