...
class Conditions extends api_1.JanusClient {
    ...
    getAllConditionsPerType(type, authMethod = 'AUTH_TOKEN', tracingConfig) {
        ...
        return this.http.get(this.routes.ConditionsByType(this.context.account, type), (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    getConditionById(type, id, authMethod = 'AUTH_TOKEN', tracingConfig) {
        const metric = 'conditions-getById';
        return this.http.get(this.routes.ConditionsById(this.context.account, type, id), (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    deleteConditionById(type, id, authMethod = 'AUTH_TOKEN', tracingConfig) {
        const metric = 'conditions-deleteById';
        return this.http.delete(this.routes.ConditionsById(this.context.account, type, id), (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    saveCondition(type, condition, authMethod = 'AUTH_TOKEN', tracingConfig) {
        ...
        return requestMethod(this.routes.ConditionsByType(this.context.account, type), condition, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    doEvaluation(type, subject, authMethod = 'AUTH_TOKEN', tracingConfig) {
        const metric = 'conditions-doEvaluation';
        return this.http.post(this.routes.ApplyConditions(this.context.account, type), subject, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    get routes() {
        return {
