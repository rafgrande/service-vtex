...
class Catalog extends api_1.JanusClient {
    ...
    getCategoryById(categoryId, authMethod = 'AUTH_TOKEN', tracingConfig) {
        ...
        return this.http.get(routes.getCategoryById(categoryId), (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    // eslint-disable-next-line max-params
    getProductsAndSkus(from = 1, to = 20, authMethod = 'AUTH_TOKEN', tracingConfig) {
        const metric = 'catalog-getProductsAndSkus';
        return this.http.get(routes.productsAndSkus(from, to), (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    getSkuById(skuId, authMethod = 'AUTH_TOKEN', tracingConfig) {
        const metric = 'catalog-getSkuMetric';
        return this.http.get(routes.getSkuById(skuId), (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    getSkuContext(skuId, authMethod = 'AUTH_TOKEN', tracingConfig) {
        const metric = 'catalog-getSkuContextMetric';
        return this.http.get(routes.getSkuContext(skuId), (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    changeNotification({ sellerId, sellerSkuId, authMethod = 'AUTH_TOKEN', }, tracingConfig) {
        const metric = 'catalog-changeNotification';
        return this.http.post(routes.changeNotification(sellerId, sellerSkuId), {}, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    createSeller(seller, authMethod = 'AUTH_TOKEN', tracingConfig) {
        const metric = 'catalog-createSeller';
        const sellerInfo = (0, seller_1.checkSellerInformation)(seller);
        return this.http.post(routes.seller(sellerInfo.SellerId), sellerInfo, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    getSellerList(authMethod = 'AUTH_TOKEN', tracingConfig) {
        const metric = 'catalog-getSellerList';
        return this.http.get(routes.sellerList, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    seller(id, authMethod = 'AUTH_TOKEN', tracingConfig) {
        const metric = 'catalog-seller';
        return this.http.get(routes.seller(id), (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    getBrandById(brandId, authMethod = 'AUTH_TOKEN', tracingConfig) {
        const metric = 'catalog-getBrandMetric';
        return this.http.get(routes.getBrandById(brandId), (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
}
