...
class RatesAndBenefits extends api_1.JanusClient {
    ...
    getAllBenefits(authMethod = defaultAuthMethod, tracingConfig) {
        ...
        return this.http.get(routes.getAllBenefits, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    getPromotionById(calculatorConfigurationId, authMethod = defaultAuthMethod, tracingConfig) {
        ...
        return this.http.get(routes.getPromotionById(calculatorConfigurationId), (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    createOrUpdatePromotion(calculatorConfiguration, authMethod = defaultAuthMethod, tracingConfig) {
        ...
        return this.http.post(routes.createOrUpdatePromotion, calculatorConfiguration, (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig));
    }
    createMultipleSkuPromotion(request, authMethod = defaultAuthMethod, tracingConfig) {
        ...
        const requestConfig = (0, request_1.getRequestConfig)(this.context, authMethod, metric, tracingConfig);
