...
export declare class Search extends AppClient {
    ...
    productsByEan: (ids: string[], salesChannel?: string | number) => Promise<SearchProduct[]>;
    productById: (id: string, cacheable?: boolean) => Promise<SearchProduct[]>;
    productsById: (ids: string[], salesChannel?: string | number) => Promise<SearchProduct[]>;
    productByReference: (id: string) => Promise<SearchProduct[]>;
    productsByReference: (ids: string[], salesChannel?: string | number) => Promise<SearchProduct[]>;
    productBySku: (skuId: string) => Promise<SearchProduct[]>;
    productsBySku: (skuIds: string[], salesChannel?: string | number) => Promise<SearchProduct[]>;
